...
public class StatsReader implements Runnable {
	...
	// 2) quais classes?
	// 3) suas skills?
	// OBS: eng skill pode ser ganha em minas colocadas ha muito tempo, o cara pode nao ser mais eng.
	...
	// private static final String s = "Allied Command Post constructed. Charge speed increased!";
	...
	private static final String[] weaponsNames = new String[] { "Airstrike", "Artillery", "Colt", "Dynamite", "FG42",
			"flamethrower", "G.Launchr", "Garand", "grenade", "K43", "K43 Rifle", "Knife", "Landmine", "Luger", "MP-40", "MP40",
			"Mortar", "Panzerfaust", "SmokeScrn", "Sten", "Syringe", "Thompson", "rifle grenade" };

	private static final String[] skills = new String[] { "Heavy Weapons", "First Aid", "Engineering", "Signals", "Covert Ops",
